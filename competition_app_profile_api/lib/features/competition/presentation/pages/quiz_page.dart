...
///
/// Routed at `/competitions/live/details/:id/opponent-found/quiz`
/// (`CompetitionRoutes.quizPath`) — `OpponentFoundPage.onCountdownComplete`
/// (wired in `CompetitionRoutes`) replaces into this route once its
/// countdown hits zero, passing the matched `MatchmakingEntry.queueId`
/// along as `extra`.
